...
st.title("🏨 Booking Cancellation Anomalies – Explainable AI Dashboard")
...
# ======================
st.markdown("## 📊 Scatterplot mit Zielvariable oder Anomalien")
...
# ========================
st.markdown("## 🧪 Modellevaluation – Isolation Forest")
...
st.subheader("Boxplot-Vergleich (LeadTime)")
fig, ax = plt.subplots()
...
# ========================
# SECTION 4: SHAP – Local
# ========================
st.markdown("## 🟣 SHAP Force Plot für eine Anomalie")
